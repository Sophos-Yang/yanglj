...
Java_com_kubolab_gnss_gnssloggerR_Logger3Fragment_resultFromJNI(JNIEnv *env, jobject instance,
...
Java_com_kubolab_gnss_gnssloggerR_Logger3Fragment_passingPathJNI(JNIEnv *env, jobject instance,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_kubolab_gnss_gnssloggerR_Logger3Fragment_passingobsDataJNI(JNIEnv *env, jobject instance,
                                                                 jintArray gpsweek_,
                                                                 ...
                                                                 jint bdsflag, jdoubleArray gpsC1_,
                                                                 jdoubleArray gpsL1_,
                                                                 jdoubleArray gpsD1_,
                                                                 jdoubleArray gpsC2_,
                                                                 jdoubleArray gpsL2_,
    ...
    for(int i = 0;i<gpssvnum;i++)
    {
        ...
        ObsData.GpsD2_t[i] = gpsD2[i];
    }
    for(int i = 0;i<bdssvnum;i++)
    {
