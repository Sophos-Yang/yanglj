...
#ifndef EXTLEX
#define MAXRCVFMT    15                 /* max number of receiver format接收机格式的最大数量 */
#else
#define MAXRCVFMT    16
#endif
...
typedef struct {        /* solution type */
    ...
    double dop[4];      /*DOP，edit by liuyi*/
    int satnum[6];      /*卫星数  0 GPS 1 BDS 2 GLO 3 GAL*/
...
EXPORT int cdcdc(gtime_t time, const nav_t *nav, const double *pos,
                      const double *azel, double *delay, double *var);

EXPORT void int2char(char *str,int num);
